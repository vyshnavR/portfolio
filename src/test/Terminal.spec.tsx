...
describe("Terminal Component", () => {
  ...
  describe("Input Commands", () => {
    ...
    it("should return '/home/vyshnav' when user type 'pwd' cmd", async () => {
  ...
  describe("Redirect commands", () => {
    ...
    it("should redirect to portfolio website when user type 'linkedin' cmd", async () => {
      await user.type(terminalInput, "linkedin{enter}");
